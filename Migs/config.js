...
const init_phones = ["Generic JM-1 Target", "Symphonium Meteor (Truthear Hola cable)"],                // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      page_title = "Migs Graph Tool",                     // Optional. Appended to the page title if share URLs are enabled
...
let headerLogoText = "Migs Graph Tool",
