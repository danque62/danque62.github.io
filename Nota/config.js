...
const init_phones = ["Generic JM-1 Target", "Hisenior Mega5-EST"],                // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
...
let headerLogoText = "Nota Graph Tool",
